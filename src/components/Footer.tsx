      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16 mb-16">
          ...
          <div className="flex flex-col items-start justify-start">
            ...
            <p className="text-slate-500 leading-relaxed text-sm pr-4 max-w-sm">
          ...
          <div className="flex flex-col items-start md:items-end justify-start">
            <div className="flex flex-col items-start w-max">
              ...
              <div className="flex items-start gap-3 text-slate-500 group">
                <div className="p-2 rounded-lg bg-slate-100 group-hover:bg-accent/10 transition-colors mt-0.5">
